...
You can switch the language used with the tabs at the top right (or from the nav menu at the top left on mobile).</aside>',
    ...
    'routes' => [
        [
            'match' => [
                ...
                // Routes have 'api' prefix from RouteServiceProvider, so match 'api/*'
                'prefixes' => ['api/*'],
            ...
            // Apply this prefix to all matched routes when generating URLs
            // This helps avoid duplicate /api/api/ in generated URLs
            'apply' => [
                'headers' => [
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by logging in through the authentication endpoints. Include the token in the Authorization header as: <code>Bearer {your-token}</code>',
    ],
